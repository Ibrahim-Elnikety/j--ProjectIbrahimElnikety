 ...
 */
class JVariableBackUp extends JExpression implements JLhs {
    // The variable's name.
    private String name;
     ...
     * @param name the name.
     */
    public JVariableBackUp(int line, String name) {
        super(line);
        this.name = name;
    }
            ...
            if (field == null) {
                ...
                JExpression newTree = new JFieldSelection(line(),
                        field.isStatic() || (context.methodContext() != null &&
                                ...
                                new JVariableBackUp(line(), definingType.toString()) : new JThis(line),
                        name);
    ...
    public JExpression analyzeLhs(Context context) {
        ...
        if (newTree instanceof JVariableBackUp) {
