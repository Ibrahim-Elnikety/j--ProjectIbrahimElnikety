...
class ScannerBackup {
     ...
     */
    public ScannerBackup(String fileName) throws FileNotFoundException {
...
class CharReaderBackUp {
     ...
     */
    public CharReaderBackUp(String fileName) throws FileNotFoundException {
